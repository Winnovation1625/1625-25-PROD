...
public class DriveToReef extends DriveToPose {
  ...
  private static final LoggedTunableNumber reefPoseOffsetXAlgae =
      new LoggedTunableNumber("DriveToReef/ReefCoralScoreXOffsetAlgae", Units.inchesToMeters(22));
  ...
  static {
    ...
    reefPoseOffsetXAlgae.initDefault(Units.inchesToMeters(22));
        ...
        () ->
            AllianceFlipUtil.apply(
                FieldConstants.Reef.centerFaces[reefFace].transformBy(
                    new Transform2d(
                        isCoral ? reefPoseOffsetX.get() : reefPoseOffsetXAlgae.get(),
                        reefPoseOffsetY.get(),
                        new Rotation2d(Degrees.of(-90))))),
        // robot position supplier
        () -> {
        ...
        () ->
            AllianceFlipUtil.apply(
                FieldConstants.Reef.centerFaces[algaeObjective.get().position().getFace()]
                    .transformBy(
                        new Transform2d(
                            isCoral.get() ? reefPoseOffsetX.get() : reefPoseOffsetXAlgae.get(),
                            reefPoseOffsetY.get(),
                            new Rotation2d(Degrees.of(-90))))),
        // robot position supplier
        () -> {
