...
public class Manipulator extends SubsystemBase {
  ...
  public enum ManipulatorState {
    ...
    SHOOTING_TELEOP_ALGAE(new LoggedTunableNumber("Manipulator/AlgaeShootingTeleopVoltage", -9)),
    SHOOTING_SLOW_ALGAE(new LoggedTunableNumber("Manipulator/AlgaeShootingSlowVoltage", -5)),
