...
public class Elevator {
  ...
  public enum ElevatorState {
    ...
    ALGAE_CLEARANCE(new LoggedTunableNumber("Superstructure/Elevator/ALGAE CLEARANCE", 0.52)),
    ...
    CLVL2(new LoggedTunableNumber("Superstructure/Elevator/CLVL2", 0.59)),
    TROUGH(new LoggedTunableNumber("Superstructure/Elevator/TROUGH", 0.26)),
    CLVL3(new LoggedTunableNumber("Superstructure/Elevator/CLVL3", 0.98)),
    CLVL4(new LoggedTunableNumber("Superstructure/Elevator/CLVL4", 1.755)),
    ALVL2(new LoggedTunableNumber("Superstructure/Elevator/ALVL2", 0.52)),
    ALVL3(new LoggedTunableNumber("Superstructure/Elevator/ALVL3", 0.95)),
